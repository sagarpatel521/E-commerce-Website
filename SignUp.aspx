          ...
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
                    <h1 class="display-7" style="font-family: Playfair Display; color: rgb(215,61,47);">Welcome!</h1>

              </div>
              <p class="login-card-description" style="font-family: Poppins; font-size: 21px;">Create New account</p>
                 <div class="col-md-9">
                    
                     <div class="form-group">
                        <asp:TextBox ID="txtName" CssClass="form-control" runat="server"  style="font-family: Poppins;" placeholder="Enter Your Full Name" TextMode="Password"></asp:TextBox>
                     </div>

                     <div class="form-group">
                        <asp:TextBox ID="txtEmail" CssClass="form-control" runat="server"  style="font-family: Poppins;" placeholder="Enter Your Email Address" TextMode="Password"></asp:TextBox>
                     </div>

                <div class="form-group">
                        <asp:TextBox ID="txtUname" CssClass="form-control" placeholder="Enter Your Username" style="font-family: Poppins;"  runat="server"></asp:TextBox>
                </div>
                
                
                     <div class="form-group">
                        <asp:TextBox ID="txtPass" CssClass="form-control" runat="server"  style="font-family: Poppins;" placeholder="Enter Your Password" TextMode="Password"></asp:TextBox>
                     </div>

                     <div class="form-group">
                        <asp:TextBox ID="txtCPass" CssClass="form-control" runat="server"  style="font-family: Poppins;" placeholder="Enter Your Confirm Password" TextMode="Password"></asp:TextBox>
                     </div>
                ...
                <div class="form-group">
                        <asp:Button ID="txtsignup" CssClass="btn btn-block login-btn mb-4" style="font-family: Poppins;" runat="server" Text="Sign Up" OnClick="txtsignup_Click" />
                </div>

                     
                <asp:HyperLink ID="HyperLink2" runat="server" CssClass="login-card-footer-text pt-2" NavigateUrl="~/SignIn.aspx" style="font-family: Poppins; ">Already have account? Log in!</asp:HyperLink>
                

                <nav class="login-card-footer-nav">
                  <a href="#!" style="font-family: Poppins;">Terms of use.</a>
                  <a href="#!" style="font-family: Poppins;">Privacy policy</a>
                </nav>
