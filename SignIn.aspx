        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description" style="font-family: Poppins; font-size: 21px;">Sign into your account</p>
                 <div class="col-md-7">
                <div class="form-group">
                        <asp:TextBox ID="txtUsername" CssClass="form-control" style="font-family: Poppins;"  runat="server"></asp:TextBox>
                </div>
                ...
                <div class="form-group">
                        <asp:TextBox ID="txtPass" CssClass="form-control" runat="server"  style="font-family: Poppins;" placeholder="********" TextMode="Password"></asp:TextBox>
                </div>
                ...
                <div class="form-group">
                        <asp:Button ID="btnLogin" CssClass="btn btn-block login-btn mb-4" style="font-family: Poppins;" runat="server" Text="Login" OnClick="btnLogin_Click" />
                </div>
                
                <asp:HyperLink ID="HyperLink1" runat="server" CssClass="forgot-password-link" style="font-family: Poppins;" NavigateUrl="~/ForgotPassword.aspx">Forgot Password?</asp:HyperLink><br />
                <asp:HyperLink ID="HyperLink2" runat="server" CssClass="login-card-footer-text pt-2" NavigateUrl="~/SignUp.aspx" style="font-family: Poppins; ">Don't have an account? Register here</asp:HyperLink>
