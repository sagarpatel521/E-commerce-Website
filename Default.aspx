                    ...
                    <ul class ="nav navbar-nav navbar-right">
                        <li class ="active"><a href ="Cart.aspx"><button id="btnCart" class="btn my-2 my-sm-0 buttonstyle" type="button">
                         ...
                         <li ><a href ="SignUp.aspx">
                             <button id="btnSignUP" runat="server" class="btn  my-2 my-sm-0 buttonstyle" type="button">
                                            SignUp

                         </button></a></li>
                        <li ><a href ="SignIn.aspx">
                             <button id="btnSignIN" class="btn  my-2 my-sm-0 buttonstyle" type="button" runat="server">
                                            SignIn
                             </button>
                         </a></li>
                        <li>
                             <asp:Button ID="btnlogout" CssClass ="btn navbar-btn my-2 my-sm-0 buttonstyle" runat="server" Text="Sign Out" OnClick="btnlogout_Click" />
                        </li>
                    </ul>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <a href ="Products.aspx"><img class="d-block w-100" src="images/banner2121.jpg" alt="Second slide"></a>
    </div>
    <div class="carousel-item">
